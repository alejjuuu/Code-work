...
#text="HELlo -- world what's up"
    ...
    newWordList = []
    for x in spliter:
        newWordList.append(x.strip(string.punctuation))   #Take a look at this one
    #print(newWordList)
    ...
    for words in wordList:
        counter= newWordList.count(words.lower())
        sumofwords+=counter
    #print(sumofwords)
    ...
    ratio=sumofwords/len(newWordList)
...
Yes, poe uses more 'a' and 'an' than neruda

Yes, poe uses more 'the' than neruda 
'''
